# Supabase и Telegram для Daniil’s English Space
...
supabase secrets set ALLOWED_STUDENT_ID="daniil"
...
RLS ограничивает строки идентификатором `daniil`, но не подтверждает личность человека. Не используйте эту архитектуру для экзамена, чувствительных данных или сайта с несколькими пользователями.
